    ...
    <>
      <footer className="w-full bg-white text-amber-700 text-sm py-6 relative">
        <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row items-center justify-between px-6 text-center md:text-left">
          ...
          <div className="flex flex-col md:flex-row items-center gap-4">
            ...
            <p className="text-gray-500 mt-2 md:mt-0">
              © {new Date().getFullYear()} SIPCO. Tous droits réservés.
            </p>
          </div>
        ...
        <div className="text-center text-gray-500 mt-4">
          <p>
            Site conçu par{" "}
            <a href="https://sipco.fr/" target="_blank" className="text-amber-700 hover:underline">
              SIPCO
            </a>
          </p>
        </div>
      ...
      <AnimatePresence>
        {showScroll && (
          <motion.button
            onClick={scrollToTop}
            className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 bg-amber-700 text-white p-3 rounded-full shadow-lg hover:scale-110 transition-all"
